...
Route::group(['prefix' => 'admin', 'middleware' => ['web', 'isAdmin']], function () {
    ...
    Route::get('/orders/{order}/view', [Accessories::class, 'viewOrder'])->name('viewOrder');
    Route::get  ('/orders/{order}/changeStatus', [Accessories::class, 'changeStatus'])->name('changeStatus');
    // Route::get('/orders/{Order}/view', [Accessories::class, 'viewOrder'])->name('viewOrder');
